    ...
    <div class="bg-white border-2 border-[#CD2828] rounded-[30px] p-8 shadow-sm flex flex-col md:flex-row gap-10">
        ...
        <div class="w-full md:w-2/3 space-y-4">
            ...
            <div class="flex gap-6 py-2 border-y border-gray-100">
                {{-- Hitung Favorit Realtime --}}
                <div class="text-sm">
                    <span class="text-gray-500 font-medium">Being favorite by</span>
                    <span class="text-[#CD2828] font-bold ml-1">
                        {{ $product->favoritedBy()->count() }} User
                    </span>
                </div>
                ...
                {{-- Hitung Penjualan Realtime (Berdasarkan Item yang terjual) --}}
                <div class="text-sm">
                ...
                {{-- Tambahan Info Stok --}}
                <div class="text-sm border-l border-gray-200 pl-6">
                    <span class="text-gray-500 font-medium">Stock Left</span>
                    <span class="{{ $product->stock <= 5 ? 'text-red-600' : 'text-green-600' }} font-bold ml-1">
                        {{ $product->stock }}
                    </span>
                </div>
            </div>
