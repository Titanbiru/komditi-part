...
<div class="min-h-screen flex items-center justify-center font-['DM_Sans'] px-4 py-12">
    <div class="w-full max-w-md bg-[#FEFEFE] p-8 md:p-10 rounded-[2.5rem] shadow-xl shadow-black/5 border-2 border-[#BABABA]/10">
        ...
        <form action="{{ route('register.process') }}" method="POST" class="space-y-5">
            ...
            <div class="space-y-2">
                <label for="name" class="block text-[10px] font-black uppercase tracking-[0.2em] text-[#202020] ml-1">
                    Full Name
                </label>
                <input 
            ...
            <div class="space-y-2">
                <label for="password" class="block text-[10px] font-black uppercase tracking-[0.2em] text-[#202020] ml-1">
                    Password
                </label>
            ...
            <div class="space-y-2">
                <label for="password_confirmation" class="block text-[10px] font-black uppercase tracking-[0.2em] text-[#202020] ml-1">
                    Confirm Password
                </label>
                <input 
            ...
            <div class="relative flex py-4 items-center">
                ...
                <span class="flex-shrink mx-4 text-[10px] font-black text-[#BABABA] uppercase tracking-widest">Atau Daftar Dengan</span>
                <div class="flex-grow border-t border-[#BABABA]/20"></div>
            </div>

            <a href="{{ route('google.login') }}" class="w-full bg-white border-2 border-[#202020] py-4 rounded-2xl font-black text-[11px] uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:bg-[#F9F9F9] transition-all">
            ...
            <div class="text-center mt-6 pt-6 border-t border-[#BABABA]/10">
                <p class="text-[11px] font-bold text-[#BABABA] uppercase tracking-wider">
                    ...
                    <a href="{{ route('login') }}" class="text-[#CD2828] hover:text-[#1BCFD5] transition-colors ml-1 font-black underline decoration-2 underline-offset-4">
                        Login
                    </a>
                </p>
            </div>
