...
@section('content')
    <div style="min-height: 100vh; display: flex; align-items: center; justify-content: center; background-color: #f3f4f6; padding: 3rem 1rem;">
        <div style="width: 100%; max-width: 28rem; background-color: white; padding: 2rem; border-radius: 0.75rem; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1), 0 4px 6px -2px rgba(0,0,0,0.05);">
            ...
            <form style="margin-top: 2rem;" action="{{ route('register.process') }}" method="POST">
                @csrf

                <!-- Nama Lengkap -->
                <div style="margin-bottom: 1.5rem;">
                    <label for="name" style="display: block; font-size: 0.875rem; font-weight: 500; color: #374151;">
                        Nama Lengkap
                    </label>
                ...
                <!-- Konfirmasi Password -->
                <div style="margin-bottom: 1.5rem;">
                    <label for="password_confirmation" style="display: block; font-size: 0.875rem; font-weight: 500; color: #374151;">
                        Konfirmasi Password
                    </label>
                    <div style="margin-top: 0.25rem;">
                        <input 
                ...
                <div style="text-align: center; margin-top: 1.5rem; font-size: 0.875rem; color: #4b5563;">
                    Sudah punya akun? 
                    <a href="{{ route('login') }}" style="color: #6366f1; font-weight: 500; text-decoration: none;"
