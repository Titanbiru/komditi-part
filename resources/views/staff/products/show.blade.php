...
<div class="mb-10 flex flex-col md:flex-row justify-between items-start md:items-end gap-4 px-2">
    ...
    <a href="{{ route('staff.products.index') }}" class="text-[10px] font-black text-[#BABABA] hover:text-[#202020] uppercase tracking-widest transition-all pb-1 border-b-2 border-transparent hover:border-[#202020]">
        ← Back to Inventory
    </a>
</div>
