...
<div class="bg-white border border-gray-100 rounded-[2.5rem] p-8 shadow-sm">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h3 class="text-sm font-black text-gray-800 uppercase tracking-widest">Produk Saya</h3>
            <p class="text-[10px] font-bold text-gray-400 uppercase tracking-tight">Koleksi barang impian kamu</p>
        </div>
        <span class="bg-red-50 text-[#CD2828] px-4 py-1 rounded-full text-[10px] font-black uppercase">
    ...
    @if($favorites->isEmpty())
        ...
        <div class="py-20 text-center space-y-4">
            ...
            <p class="text-gray-400 font-bold uppercase text-xs">Belum ada produk favorit</p>
